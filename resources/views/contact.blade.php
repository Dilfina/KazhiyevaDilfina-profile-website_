...
.dropdown{
 ...
 <section class="contact" id="contact">
      	<div class="heading">
      		<h2 style="color:#f00; padding-top:60px">{{__('Contact Me')}}</h2>
      		<p>{{__('If you have any questions, you can contact me.')}}</p>
      	</div>
      	<div class="content">
      		...
      		<div class="formBx">
      			<form>
      				<h3>{{__('Message Me')}}</h3>
      				<input type="text" name="" placeholder="{{__('Full Name')}}">
      				<input type="email" name="" placeholder="{{__('Email')}}">
      				<textarea placeholder="{{__('Your Message')}}"></textarea>
      				<input type="submit" style="width:400px;"value="{{__('Send')}}">
      			</form>
      		</div>
      	</div>
      </section>
      <div class="copyright">
      	<p>{{__('Created by Dilfina. All Right Reserved.')}}</p>
      </div>
